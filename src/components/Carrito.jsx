...
const Carrito = () => {
    ...
    const comp = ["mando","Keyboard & mouse bundle","$39"];
    ...
    return <div className="container-fluid" style={{backgroundColor:`#383c4c`}}>
        <div className="row">
            ...
            <div className="col-1" id='iconos1'> <Link to="/" style={{color:`white`}} >Home</Link> </div>
            ...
            <div className="col" id='ccaja1'> 
                <a href='http://google.com.pe'><img src={lupa} hspace="8" /></a>
                <Link to="/registro"><img src={iconper} hspace="8" /></Link>
                <a href='http://google.com.pe'></a><img src={carrito} hspace="8" />
            </div>
        </div>
